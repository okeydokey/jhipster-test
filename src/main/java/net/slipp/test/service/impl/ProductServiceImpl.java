package net.slipp.test.service.impl;

import net.slipp.test.service.ProductService;
import net.slipp.test.domain.Product;
import net.slipp.test.repository.ProductRepository;
import net.slipp.test.repository.search.ProductSearchRepository;
import net.slipp.test.service.dto.ProductDTO;
import net.slipp.test.service.mapper.ProductMapper;
