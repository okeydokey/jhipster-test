package net.slipp.test.config.social;

import net.slipp.test.repository.SocialUserConnectionRepository;
import net.slipp.test.repository.CustomSocialUsersConnectionRepository;
import net.slipp.test.security.jwt.TokenProvider;
import net.slipp.test.security.social.CustomSignInAdapter;
