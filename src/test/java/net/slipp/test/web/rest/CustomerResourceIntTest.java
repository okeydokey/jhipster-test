...
import net.slipp.test.service.CustomerService;
import net.slipp.test.repository.search.CustomerSearchRepository;
import net.slipp.test.service.dto.CustomerDTO;
import net.slipp.test.service.mapper.CustomerMapper;
...
import net.slipp.test.domain.enumeration.CustomerLevel;
/**
